...
async function run() {
  ...
  app.put('/api', (req, res) => {
    ...
    // Perform the necessary operations to update the data in the database
    // For example, you can update the data in the MongoDB collection using the MongoDB driver
